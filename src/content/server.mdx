...
The easiest way to run Creddy as a service:
...
This automatically:
- Creates a systemd unit file with security hardening
- Creates the data directory (`/var/lib/creddy`)
