...
|------|--------|----------|
| **Legacy Token** | `ckr_xxx...` | Simple auth, direct API access |
...
Skip the OAuth exchange, use the `ckr_` token directly:
...
Use OIDC for production. Use legacy for quick testing or simple setups.
