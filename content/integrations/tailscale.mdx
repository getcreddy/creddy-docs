...
<div className="diagram-invertible-wrapper">
  <img src="/diagrams/tailscale-flow.svg" alt="Tailscale vend flow diagram" />
</div>
...
> **Authentication**: Agents can authenticate to Creddy using either [vend tokens](/docs/authentication#vend-token-authentication) (`ckr_xxx`) or [OIDC](/docs/oidc) (`client_id`/`client_secret`). Both work with Tailscale.
