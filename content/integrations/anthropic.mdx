...
<div className="diagram-invertible-wrapper">
  <img src="/diagrams/anthropic-flow.svg" alt="Anthropic proxy flow diagram" />
</div>
...
> **Authentication**: Agents can authenticate to Creddy using either [vend tokens](/docs/authentication#vend-token-authentication) (`ckr_xxx`) or [OIDC](/docs/oidc) (`client_id`/`client_secret`). Both work with Anthropic.
